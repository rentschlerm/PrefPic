...
$procedure_serial = $_REQUEST["ProcedureSerial"];
// get the new values for updates
$name 			= $_REQUEST["Name"];
$never			= $_REQUEST["Never"];
$check 			= $_REQUEST["Check"];
$always 		= $_REQUEST["Always"];
...
$log_sql= 'insert web_log SET method="UpdateProcedure", text="'. $text. '", created="' . date("Y-m-d H:i:s") .'"';
...
<ErrorNumber>0</ErrorNumber>
<Result>Success</Result>
<Message>Procedure updated successfully</Message>
